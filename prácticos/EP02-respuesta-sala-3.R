...
# ambas tablas 
medidas_hombres <- hombres_TF %>% summarise(Media = mean(ytot),
                                          Dstandar = sd(ytot),
                                          Varianza = var(ytot)) 

medidas_mujeres <- mujeres_TF %>% summarise(Media = mean(ytot),
                                          Dstandar = sd(ytot),
                                          Varianza = var(ytot))



# Generando histogramas para los ingresos totales
