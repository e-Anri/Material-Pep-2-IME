...
#Usando como semilla el año y mes de nacimiento de un/a miembro del equipo (ej.: 198012), seleccionen una muestra
#de 500 casos de los datos
...
# Usando correlation matrix to select preditors
...
# Finalmente, con todas las pruebas realizadas y condiciones expuestas,
#podemos concluir que el modelo ajustado y propuesto es un modelo admisible.